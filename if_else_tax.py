...
Once upon a time there was a land of milk and honey, inhabited by happy and prosperous people. The people 
...
short) had to be paid once a year, and was evaluated using the following rule:
    ...
    thalers and 2 cents (this was what they called tax relief)
...
Your task is to write a tax calculator.
    ...
    Next, it should print the calculated tax, rounded to full thalers. There's a function named round() which will 
    do the rounding for you. You'll find it in the skeleton code in the editor.
	
Note: this happy country never returned any money to its citizens. If the calculated tax was less than zero, 
