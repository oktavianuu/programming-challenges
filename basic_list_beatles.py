...
Write a program that reflects these changes and lets you practice with the concept of lists. Your task is to:
    ...
    step 3: use the for loop and the append() method to prompt the user to add the following members of the     
...
beatles.append("George Harison")
print("Step 2:", beatles)

for x in range(2):
    new_member = input("Enter new member of The Beatles: ")
