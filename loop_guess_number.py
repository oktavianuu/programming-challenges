...
He wants everyone who runs his program to play the Guess the secret number game, and guess what number 
he has picked for them. Those who don't guess the number will be stuck in an endless loop forever! Unfortunately, 
...
+================================+
""")
user_guess = int(input("Guess the numbers: "))
while user_guess != secret_number:
    if user_guess != secret_number:
        print("Ha ha! You're stuck in my loop!")

    # ask the user to guess again1
    user_guess = int(input("Guess the numbers: "))
